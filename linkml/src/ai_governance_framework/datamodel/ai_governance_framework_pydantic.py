...
linkml_meta = LinkMLMeta({'default_prefix': 'ai_governance_framework',
     'default_range': 'string',
     'description': 'A FINOS-curated instance dataset of the ai-atlas-nexus '
                    '[`ai-risk-ontology`](https://github.com/finos/ai-governance-framework).\n'
                    '\n'
                    'The '
                    '[schema](https://github.com/lmodel/ai-governance-framework/blob/main/linkml/src/ai_governance_framework/schema/ai_governance_framework.yaml) '
                    'and\n'
                    'cross-walked to ISO 42001 / NIST AI 600-1 / DPV / AIRO / '
                    'OWASP via\n'
                    'SSSOM mapping files under '
                    '`/src/ai_governance_framework/mappings/`.\n'
                    '\n'
                    'The [ai-atlas-nexus](https://ibm.github.io/ai-atlas-nexus/) '
                    'upstream is vendored under `./ai_risk_ontology/`\n'
                    'until the `https://w3id.org/ai-atlas-nexus/` redirect goes '
                    "live.'",
     'id': 'https://w3id.org/lmodel/ai-governance-framework',
     'imports': ['linkml:types', './ai_risk_ontology/ai-risk-ontology'],
     'license': 'Apache-2.0',
...
class Documentation(Entity):
    ...
    hasLicense: Optional[str] = Field(default=None, description="""Indicates licenses associated with a resource""", json_schema_extra = { "linkml_meta": {'domain_of': ['Dataset',
                       ...
                       'Adapter'],
         'slot_uri': 'airo:hasLicense'} })
    hasJurisdiction: Optional[list[Jurisdiction]] = Field(default=None, description="""The legal or political jurisdiction(s) in which this concept applies, expressed as ISO 3166-1 country codes.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Documentation', 'Concept'], 'slot_uri': 'dpv:hasJurisdiction'} })
...
class Entry(Entity):
    ...
    isPartOf: Optional[str] = Field(default=None, description="""A relationship where an entity is part of another entity""", json_schema_extra = { "linkml_meta": {'domain_of': ['Entry',
                       ...
                       'CapabilityGroup'],
         'slot_uri': 'schema:isPartOf'} })
    requiredByTask: Optional[list[str]] = Field(default=None, description="""Indicates that this entry is required to perform a specific AI task.""", json_schema_extra = { "linkml_meta": {'domain': 'Capability',
...
class RiskIncident(RiskConcept, Entity):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'class_uri': 'dpv_risk:Incident',
         'from_schema': 'https://w3id.org/ai-atlas-nexus/ai_risk',
         'mixins': ['RiskConcept']})
...
class Adapter(LargeLanguageModel, Entry):
    ...
    implementsCapability: Optional[list[str]] = Field(default=None, description="""Indicates that this adapter implements a specific capability""", json_schema_extra = { "linkml_meta": {'domain': 'Adapter', 'domain_of': ['Adapter', 'LLMIntrinsic']} })
    hasCapability: Optional[list[str]] = Field(default=None, description="""Indicates the technical capabilities this entry possesses.
...
""", json_schema_extra = { "linkml_meta": {'domain_of': ['AiSystem', 'Adapter', 'LLMIntrinsic'],
         'slot_uri': 'tech:hasCapability'} })
    implementsCapability: Optional[list[str]] = Field(default=None, description="""Indicates that this entity implements a specific capability""", json_schema_extra = { "linkml_meta": {'domain': 'LLMIntrinsic', 'domain_of': ['Adapter', 'LLMIntrinsic']} })
    isDefinedByTaxonomy: Optional[str] = Field(default=None, description="""A relationship where a concept or a concept group is defined by a taxonomy""", json_schema_extra = { "linkml_meta": {'domain_of': ['Concept',
                       'Control',
                       'Group',
                       'Entry',
